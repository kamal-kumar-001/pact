...
export default function Leaderboard() {
  return (
    <section className="relative mx-auto w-full max-w-6xl px-6 py-20">
      <div className="absolute right-10 top-10 -z-10 h-36 w-36 rounded-full bg-indigo-400/10 blur-3xl" />
      <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3 text-sm uppercase tracking-[0.3em] text-gray-400">
            <span>Leaderboards</span>
            <span className="flex h-7 w-7 items-center justify-center rounded-full border border-white/10 bg-black/60 text-indigo-300 shadow-[0_0_18px_rgba(129,140,248,0.35)]">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_0_40px_rgba(129,140,248,0.12)]">
